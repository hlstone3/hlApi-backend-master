...
import static com.stone.hlapi.constant.UserConstant.USER_LOGIN_STATE;
...
import com.stone.hlapi.mapper.UserMapper;
import com.stone.hlapi.model.dto.user.UserQueryRequest;

import com.stone.hlapi.model.enums.UserRoleEnum;
...
import com.stone.hlapi.utils.GenerateKeyUtils;
...
import com.stone.hlapicommon.model.vo.UserVO;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "stone";

    private static final String USER_AVATAR_URL = "https://www.loliapi.com/acg/pp/";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            // 4. 根据加密算法生成accessKey和secretKey
            String accessKey = GenerateKeyUtils.GenerateAccessKey(userAccount);
            String secretKey = GenerateKeyUtils.GenerateSecretKey(userAccount);
            // 3. 插入数据
            User user = new User();
            ...
            String redirectUrl = "";
            try {
                redirectUrl = getRedirectUrl(USER_AVATAR_URL);
            } catch (Exception e) {
